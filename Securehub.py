...
def extrasMenu():
    ...
    print(" --------------------------------- ")
    print(" What would you like to do? ")
    print(" OPTION 1: About SECURE HUB ")
...
def aboutSooty():
    print(' Secure Hub is a tool developed and targeted to help automate some tasks that SOC Analysts perform.')
    extrasMenu()

def contributors():
    print(' CONTRIBUTORS')
    print(" Niteesh Yandrapudi - 21BTRCC04")
    print(" Pranav G V - 21BTRCC026")
    print(" Aayush R Poorjary - 21BTRCC002")
    print(" Jnana Sagar Narayan Belamkar - 21BTLCC003")
